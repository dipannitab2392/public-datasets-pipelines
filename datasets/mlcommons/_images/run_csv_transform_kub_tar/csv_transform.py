...
def main(
    ...
    df=process_tar_file(source_file_tar,extraction_location,upload_location)
    df=df.drop(columns= ['file_current_location'])
...
def process_tar_file(source_file_tar,extraction_location,upload_location) :
    ...
    tar = tarfile.open(source_file_tar, mode='r:')
