...
with DAG(
    dag_id="google_political_ads_test.last_updated",
    ...
    last_updated_transform_csv = kubernetes_pod.KubernetesPodOperator(
        ...
        image="{{ var.json.google_political_ads_test.container_registry.run_csv_transform_kub }}",
        service_account_name="public-data-goog-political-ads",
        env_vars={
            "SOURCE_URL": "gs://political-csv-dev/google-political-ads-transparency-bundle.zip",
            "SOURCE_FILE": "files/data.zip",
            "FILE_NAME": "google-political-ads-transparency-bundle/google-political-ads-updated*",
            "TARGET_FILE": "files/data_output.csv",
            "TARGET_GCS_BUCKET": "{{ var.value.composer_bucket }}",
            "TARGET_GCS_PATH": "data/google_political_ads_test/last_updated/data_output.csv",
    ...
    load_last_updated_to_bq = gcs_to_bigquery.GCSToBigQueryOperator(
        ...
        source_objects=["data/google_political_ads_test/last_updated/data_output.csv"],
        source_format="CSV",
        destination_project_dataset_table="google_political_ads_test.last_updated",
        skip_leading_rows=1,
        write_disposition="WRITE_TRUNCATE",
        impersonation_chain="public-data-goog-political-ads@bigquery-public-data-dev.iam.gserviceaccount.com",
        schema_fields=[
            {
